...
Before enabling it, you need an EVPN-capable external fabric reachable from each SNO. That fabric must carry the EVPN address family and VXLAN traffic between PHX and CHI. Populate:
